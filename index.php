...
<title>Online Farm Machinery System</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Register and hire farm machines here</h1>
            <p>We have many machines you can choose from</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Machines for your farm</span></h2>
      <p>Find and Book farm machinery here</p>
    </div>
    <div class="row"> 
